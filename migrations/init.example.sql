...
CREATE TABLE products (
    ...
    CONSTRAINT fk_products_unit_id FOREIGN KEY (unit_id) REFERENCES units(id) ON DELETE CASCADE
);
...
CREATE TABLE transaction_items (
    ...
    CONSTRAINT fk_transactions_items_user_id FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE
);